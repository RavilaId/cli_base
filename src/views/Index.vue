                              ...
                              <div class="table-responsive">
                                  <table class="table table-striped table-borderless table-vcenter mb-0">
                                      ...
                                      <tr>
                                          ...
                                          <td class="col-6">
                                              {{index_datos.mqtt_cloud_id || "ESP3200000000000"}}
                                          </td>
                                      </tr>
                                      <tr>
                              ...
                              <div class="table-responsive">
                                  <table class="table table-striped table-borderless table-vcenter mb-0">
                                      ...
                                      <tr>
                                          ...
                                          <td class="col-6">
                                              {{index_datos.wifi_ipv4 || "000.000.000.000"}}
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">MAC WiFi:</td>
                                          <td class="col-6">
                                              {{index_datos.wifi_mac || "00:00:00:00:00:00"}}
                                          </td>
                                      </tr>
                                      <tr>
                              ...
                              <div class="table-responsive">
                                  <table class="table table-striped table-borderless table-vcenter mb-0">
                                      ...
                                      <tr>
                                          ...
                                          <td class="col-6">
                                              {{index_datos.device_cpu_clock || 0}} MHz
                                          </td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                          ...
                                          <td class="col-6">
                                              {{index_datos.device_flash_size || 4.0}} MB
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">SPIFFS SIZE:</td>
                                          <td class="col-6">
                                              {{index_datos.device_spiffs_total/1000 || 15.31}} KB
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">SPIFFS USED:</td>
                                          <td class="col-6">
                                              {{index_datos.device_spiffs_used/1000 || 0}} KB
                                          </td>
                                      </tr>
                                      <tr>
