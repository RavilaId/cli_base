                            ...
                            <section id="basic-input-groups">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="buttons">
                                            <button @click="downloadSettings" class="btn icon btn-secondary"><i class="fa fa-file-download"> </i> Exportar</button>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="buttons">
                                            <button @click="showAlertConfirm('Restablecer','¿Está seguro de vover a las configraciones de fábrica?','question', 'restore')" class="btn icon btn-warning"><i class="fa fa-undo"></i> Restablecer</button>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <button @click="uploadSettings" class="btn btn-primary" type="button" id="btnFileAdd">Importar</button>
                                        </div>
                                    </div>
                                </div>
                            </section>
