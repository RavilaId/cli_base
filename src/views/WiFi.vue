                                        ...
                                        <div class="block block-rounded mb-1">
                                            <div class="" role="tab" id="accordion_h1">
                                                <a class="fw-semibold" data-bs-toggle="collapse" data-bs-parent="#accordion" href="#ipStaticDHCP" aria-expanded="true" aria-controls="ipStaticDHCP">
                                                    <i class="fa fa-fw fa-cog opacity-50 me-1 d-none d-sm-inline-block"></i> Opciones Avanzadas
                                                </a>
                                            </div>
                                            <div id="ipStaticDHCP" class="collapse" role="tabpanel" aria-labelledby="accordion_h1" data-bs-parent="#accordion">
                                                <div class="block-content">
                                                    <div class="col-12 mb-2">
                                                        <div class="form-group">
                                                            <label class="form-label" for="wifi_ip_static">IP Options</label>
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="dir_wifi_ipv4" class="form-control" placeholder="192.168.0.100" v-model.trim="wifi.wifi_ipv4" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mb-2">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-12 mb-2">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <input type="text" id="p_wifi_gateway" class="form-control" placeholder="192.168.0.1" v-model.trim="wifi.wifi_gateway" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12 mb-2">
                                                        <div class="form-group">
                            ...
                            <div v-else>
                                <div class="table-responsive">
                                    <table class="table table-borderless">
                                        <thead>
                                            <tr>
                                                <th class="text-center" style="width: 25%;">SSID | Canal</th>
                                                <th class="text-center" style="width: 15%;">Señal <br> (dBm)</th>
                                                <th class="text-center d-none d-sm-table-cell" style="width: 30%;">BSSID</th>
                                                <th class="text-center d-none d-sm-table-cell" style="width: 30%;">Seguridad</th>
                                                <th class="text-center" style="width: 100px;">Acción</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <!-- Desestructurar el objeto wifi -->
                                            <tr v-for="{n, ssid, channel, rssi, bssid, secure} in networks.data" :key="n">          
                                                ...
                                                <td class="text-center">            
                                                    <button type="button" class="btn btn-success" @click="selectWiFi(ssid)">
                                ...
                                <button @click="get_wifi_scan" type="button" class="btn btn-alt-success me-1 mb-3 mt-3" v-if="!scan">
