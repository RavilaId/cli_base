                              ...
                              <div class="table-responsive">
                                  <table class="table table-striped table-borderless table-vcenter mb-0">
                                      ...
                                      <tr>
                                          ...
                                          <td class="col-6">
                                              {{dash_datos.mqtt_server || "cannot connect to server"}}
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">Usuario MQTT:</td>
                                          <td class="col-6">
                                              {{dash_datos.mqtt_user || "user not exist"}}
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">Cliente ID MQTT:</td>
                                          <td class="col-6">
                                              {{dash_datos.mqtt_cloud_id || "ESP3200000000000"}}
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">Actividad:</td>
                                          <td class="col-6">
                                              <span class="badge bg-secondary">{{dash_datos.mqtt_activity || "Unknown"}}</span>
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">Ruta del Topico:</td>
                                          <td class="col-6">
                                              v1/devices/{{dash_datos.mqtt_user || "user not exist"}}/{{dash_datos.device_serial || "ESP3200000000000"}}/#
                                          </td>
                                      </tr>
                                  </table>
                              </div>
                              ...
                              <div class="table-responsive">
                                  <table class="table table-striped table-borderless table-vcenter mb-0">
                                      ...
                                      <tr>
                                          ...
                                          <td class="col-6">
                                              {{dash_datos.wifi_ssid || "cannot connect to WiFi"}}
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">IP WiFi:</td>
                                          <td class="col-6">
                                              {{dash_datos.wifi_ipv4 || "000.000.000.000"}}
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">MAC WiFi:</td>
                                          <td class="col-6">
                                              {{dash_datos.wifi_mac || "00:00:00:00:00:00"}}
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">RSSI WiFi:</td>
                                          <td class="col-6">
                                              {{dash_datos.wifi_rssi || 0}} dBm
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">Modo WiFi:</td>
                                          <td class="col-6">
                                              <span class="badge bg-primary">{{dash_datos.wifi_mode || "Unknown"}}</span>
                                          </td>
                                      </tr>
                                  </table>
                              </div>
                              ...
                              <div class="table-responsive">
                                  <table class="table table-striped table-borderless table-vcenter mb-0">
                                      ...
                                      <tr>
                                          ...
                                          <td class="col-6">
                                              {{dash_datos.device_fw_version || "v0.0.00-Build-00000000"}}
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">SDK:</td>
                                          <td class="col-6">
                                              {{dash_datos.device_sdk || "v0.0.0-0-000000000"}}
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">Versión del Hardware:</td>
                                          <td class="col-6">
                                               {{dash_datos.device_hw_version || "ADMINVUE32 v0 00000000"}}
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">CPU FREQ:</td>
                                          <td class="col-6">
                                              {{dash_datos.device_cpu_clock || 0}} MHz
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">RAM SIZE:</td>
                                          <td class="col-6">
                                              {{dash_datos.device_ram_size/1000 || 35.08}} KB
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">FLASH SIZE:</td>
                                          <td class="col-6">
                                              {{dash_datos.device_flash_size || 4.0}} MB
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">SPIFFS SIZE:</td>
                                          <td class="col-6">
                                              {{dash_datos.device_spiffs_total/1000 || 15.31}} KB
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">SPIFFS USED:</td>
                                          <td class="col-6">
                                              {{dash_datos.device_spiffs_used/1000 || 0}} KB
                                          </td>
                                      </tr>
                                      <tr>
                                          <td class="col-3">Fabricante:</td>
                                          <td class="col-6">
                                               {{dash_datos.device_manufacturer || "WEBIOT"}}
                                          </td>
                                      </tr>
                                  </table>
                              </div>
